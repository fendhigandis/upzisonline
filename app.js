...
async function logout() {
    try {
        ...
        profileSettings = { lembaga: '', periode: '', ketua: '', bendahara: '', username: 'bendahara', password: 'admin', relawan: [], anggota: [], logoBase64: 'icon-192.png', activeYear: new Date().getFullYear() };
        asalRanting = ""; 
...
// =====================================================================
// --- 11. MENDAFTARKAN SEMUA FUNGSI KE WINDOW (TERMASUK FITUR PRO) ---
// =====================================================================
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('./sw.js?v=final_pro_1')
