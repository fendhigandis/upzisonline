...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // PERBAIKAN: Kata 'user' sekarang didefinisikan dengan benar
    ...
    document.getElementById('form-login').addEventListener('submit', async e => {
        e.preventDefault(); 
        try { 
            await window.authServices.signInWithEmailAndPassword(window.auth, document.getElementById('l-user').value, document.getElementById('l-pass').value); 
        } catch(err){ 
