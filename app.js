...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Mendaftarkan Service Worker DENGAN CACHE BUSTING v=999
    ...
    // -----------------------------------------------------------------
    // --- FUNGSI LOGIN (SUDAH DIKUNCI GANDA) ---
    // -----------------------------------------------------------------
    ...
    // Eksekusi Login jika form di-enter
    ...
    // Eksekusi Login jika tombol diklik (Tombol sekarang adalah type="button")
